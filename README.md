...
The main map allows you to visualize the Combined Score of each of the communities in Calgary.  To view further details, click a community on the map.  The top two charts on the left side display the suitabilty metrics in graphical form for the selected community.  This allows the user to easily obtain suitability metrics for any community, and compare the suitability of communities for green space development across Calgary.
